...
version = geocamUsersWeb.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamUsersWeb.get_version()
...
htmlhelp_basename = 'geocamUsersWebdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamUsersWeb Documentation',
   u'Trey Smith', 'manual'),
]
